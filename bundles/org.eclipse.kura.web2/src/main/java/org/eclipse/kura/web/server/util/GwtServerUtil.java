...
public final class GwtServerUtil {
    ...
    private static Object getUserDefinedObjectScalar(GwtConfigParameter param, Object currentObjValue) {
        ...
        if (param.getType() == GwtConfigParameterType.PASSWORD) {
            ...
            if (PASSWORD_PLACEHOLDER.equals(strValue)) {
            ...
            // Explicit empty value: store an empty password so the snapshot entry exists
            // and prevents a non-empty metatype default from being re-applied on merge.
    ...
    public static GwtConfigParameter toGwtConfigParameter(final AD ad, final Object value) {
        ...
        if (gwtParam.getType().equals(GwtConfigParameterType.PASSWORD)
            ...
            // Always show placeholder for scalar password fields regardless of whether
            // a value is set, so the field is never shown blank in the UI.
