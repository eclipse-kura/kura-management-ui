...
public final class WiresBlinkServlet extends HttpServlet implements WireAdminListener {
    ...
    /** Bundle Context */
    private static final BundleContext BUNDLE_CONTEXT = FrameworkUtil.getBundle(WiresBlinkServlet.class)
            .getBundleContext();
    ...
    private synchronized void addContext(final RequestContext context) {
        ...
        if (registration == null) {
            registration = BUNDLE_CONTEXT.registerService(WireAdminListener.class, this, WIRE_EVENT_LISTENER_PROPERTIES);
    ...
    private final class RequestContext {
        ...
        void run() {
            ...
            while (processEvent(startTime)) {
                // the work is done by processEvent
                continue;
            }
