...
public class FileServlet extends AuditServlet {
    ...
    // Properties of the command service configuration
    private static final String COMMAND_ENABLE = "command.enable";
    private static final String COMMAND_WORKING_DIRECTORY = "command.working.directory";
    private static final String PRIVILEGED_COMMAND_SERVICE_ENABLE = "privileged.command.service.enable";
    ...
    private void unZipInCommandWorkingDirectory(DiskFileItem archive) throws ServletException, IOException {
        ...
        String workingDir = (String) commandServiceReference.getProperty(COMMAND_WORKING_DIRECTORY);
