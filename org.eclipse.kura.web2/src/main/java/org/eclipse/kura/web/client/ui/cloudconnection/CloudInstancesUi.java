...
public class CloudInstancesUi extends Composite {
    ...
    public CloudInstancesUi(final CloudConnectionsUi cloudServicesUi) {
        ...
        this.selectionModel.addSelectionChangeHandler(event -> {
            ...
            if (selected instanceof GwtCloudConnectionEntry cloudConnection) {
                isEndpoint = true;
    ...
    public boolean setStatus(final String pid, final GwtCloudConnectionEntry.GwtCloudConnectionState state) {
        ...
        for (final GwtCloudEntry entry : entries) {
            if (pid.equals(entry.getPid()) && entry instanceof GwtCloudConnectionEntry connEntry) {
    ...
    private void initConnectionButtons() {
        ...
        this.newPubSub.addClickHandler(event -> {
            ...
            if (!(entry instanceof GwtCloudConnectionEntry connectionEntry)) {
                return;
            }

            showNewPubSubModal(connectionEntry.getCloudConnectionFactoryPid());
        });
    ...
    private void initPidColumn() {
        ...
        TextColumn<GwtCloudEntry> col = new TextColumn<GwtCloudEntry>() {
            ...
            public void render(Context context, GwtCloudEntry object, SafeHtmlBuilder sb) {
                ...
                if (object instanceof GwtCloudPubSubEntry entry) {

                    final String iconStyle = entry
    ...
    private void initCloudConnectionStatusColumn() {
        ...
        TextColumn<GwtCloudEntry> col = new TextColumn<GwtCloudEntry>() {
            ...
            public String getValue(GwtCloudEntry object) {
                ...
                if (!(object instanceof GwtCloudConnectionEntry entry)) {
                    return "";
                }
    ...
    private void initCloudConnectionFactoryPidColumn() {
        ...
        TextColumn<GwtCloudEntry> col = new TextColumn<GwtCloudEntry>() {
            ...
            public String getValue(GwtCloudEntry object) {
                ...
                if (object instanceof GwtCloudConnectionEntry entry) {
                    return entry.getCloudConnectionFactoryPid();
                }
    ...
    private void showDeleteModal() {
        this.alertDialog.show(MSGS.cloudServiceDeleteConfirmation(), () -> {
            ...
            if (selection instanceof GwtCloudConnectionEntry entry) {
